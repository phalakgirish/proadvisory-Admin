...
import { AllCategoryService } from './all-services-category.service';
...
@Component({
  selector: 'app-all-services-category',
  ...
  templateUrl: './all-services-category.component.html',
  styleUrl: './all-services-category.component.scss'
})
export class AllServicesCategoryComponent {
columnDefinitions = [
   ...
   dataSource = new MatTableDataSource<AllCategoryModule>([]);
   selection = new SelectionModel<AllCategoryModule>(true, []);
   ...
   constructor(
     ...
     private allPackageService: AllCategoryService,
   ...
   editCall(row: AllCategoryModule) {
   ...
   openDialog(action: 'add' | 'edit', data?: AllCategoryModule) {
   ...
   loadData() {
     this.allPackageService.getAllBookingList().subscribe({
       next: (data: AllCategoryModule[]) => {
         this.dataSource.data = data;
         this.isLoading = false;
         this.refreshTable();
         this.dataSource.filterPredicate = (data: AllCategoryModule, filter: string) =>
   ...
   onContextMenu(event: MouseEvent, item: AllCategoryModule) {
   ...
   deleteItem(row: AllCategoryModule){}
   checkOut(row: AllCategoryModule){}
   cancelBooking(row: AllCategoryModule){}
}
